...
function StudentViewCourseProgressPage() {
  ...
  <Dialog open={showCourseCompleteDialog}>
    <DialogContent showOverlay={false} className="sm:w-[425px] bg-[#28292b] border border-gray-600 shadow-lg rounded-lg">
      <DialogHeader>
        <DialogTitle className="text-lg font-bold text-green-400">🎉 Congratulations!</DialogTitle>
